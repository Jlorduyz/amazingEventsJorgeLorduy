let todo = [
  {
    ...
    name: "Casanare",
    description:
      "Casanare es uno de los treinta y dos departamentos que, junto con Bogotá, Distrito Capital, forman la República de Colombia. Su capital es Yopal. Está ubicado en la región Orinoquía, limitando al norte con Arauca, al este con Vichada, al sur con Meta y al oeste con Boyacá. Con 44 490\u00A0km² es el décimo departamento más extenso —por detrás de Amazonas, Vichada",
    cityCapitalId: 380,
    municipalities: 19,
    surface: 44640,
    population: 442068,
  ...
  },
  {
    ...
    name: "La Guajira",
    description:
      "La Guajira (en wayuunaiki: Wajiira o Karibyczonn) es uno de los treinta y dos departamentos que, junto con Bogotá, Distrito Capital, forman la República de Colombia. La traducción más precisa de su nombre sería «Caribe hermoso» y en wayunaiki antiguo Karive Pala «Mar Caribe» también puede significar Mar del Caribe. Su capital es Riohacha. Está ubicado en el extremo noreste del país, en la región Caribe, limitando al norte y este con el mar Caribe (océano Atlántico), al sureste con el estado Venezolano del Zulia, al sur con el departamento del Cesar y al oeste con el del Magdalena.",
    cityCapitalId: 694,
    municipalities: 15,
    surface: 20848,
    population: 1002394,
  ...
  },
  {
    ...
    name: "Santander",
    description:
      "Santander es uno de los treinta y dos departamentos que, junto con Bogotá, Distrito Capital, forman la República de Colombia. Su capital es Bucaramanga. Está ubicado al noreste del país, en la región andina, limitando al norte con Cesar y Norte de Santander, al este y sur con Boyacá, al oeste con Antioquia y al noroeste con Bolívar.7​ Con unos 2 280 908 habitantes en 2018 es el sexto departamento por población. Recibe su nombre en alusión a Francisco de Paula Santander, prócer de la independencia de la Nueva Granada",
    cityCapitalId: 915,
    municipalities: 87,
    surface: 30537,
    population: 2324090,
  ...
  },
  {
    ...
    name: "Tolima",
    description:
      "Tolima es uno de los treinta y dos departamentos que, junto con Bogotá, Distrito Capital, forman la República de Colombia. Su capital es Ibagué. Está ubicado en el centro-oeste del país, en la región andina, limitando al norte con Caldas, al este con Cundinamarca, al sur con Huila y Cauca; y al oeste con Valle del Cauca, Quindío y Risaralda.6​ El río Magdalena atraviesa Tolima de sur a norte.",
    cityCapitalId: 1069,
    municipalities: 47,
    surface: 23562,
    population: 1346935,
